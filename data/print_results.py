...
def print_results(results_dic, results_stats_dic, model, 
    ...
    """    
    print(f"The model being used is - {model}")
    print('The overall counts are as below- ')
